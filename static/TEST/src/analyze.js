...
function analyse() {
    ...
    generateDonut('memberCanvas3', [eachMemberMessages[2] - eachMemberStickers[2] - eachMemberPhotos[2], eachMemberStickers[2], eachMemberPhotos[2]], ['#EB9F9F', '#F0E5DE', '#7C7877']);
    generateDonut('memberCanvas4', [eachMemberMessages[3] - eachMemberStickers[3] - eachMemberPhotos[3], eachMemberStickers[3], eachMemberPhotos[3]], ['#EB9F9F', '#F0E5DE', '#7C7877']);
    generateDonut('memberCanvas5', [eachMemberMessages[4] - eachMemberStickers[4] - eachMemberPhotos[4], eachMemberStickers[4], eachMemberPhotos[4]], ['#EB9F9F', '#F0E5DE', '#7C7877']);
    generateDonut('memberCanvas6', [eachMemberMessages[5] - eachMemberStickers[5] - eachMemberPhotos[5], eachMemberStickers[5], eachMemberPhotos[5]], ['#EB9F9F', '#F0E5DE', '#7C7877']);
    generateDonut('memberCanvas7', [eachMemberMessages[6] - eachMemberStickers[6] - eachMemberPhotos[6], eachMemberStickers[6], eachMemberPhotos[6]], ['#EB9F9F', '#F0E5DE', '#7C7877']);
    generateDonut('memberCanvas8', [eachMemberMessages[7] - eachMemberStickers[7] - eachMemberPhotos[7], eachMemberStickers[7], eachMemberPhotos[7]], ['#EB9F9F', '#F0E5DE', '#7C7877']);
    generateDonut('memberCanvas9', [eachMemberMessages[8] - eachMemberStickers[8] - eachMemberPhotos[8], eachMemberStickers[8], eachMemberPhotos[8]], ['#EB9F9F', '#F0E5DE', '#7C7877']);
...
function displayResult() {
    ...
    const member9Name = document.querySelector('[member9-name]')
    const member1Message = document.querySelector('[member1-message]')
    const member2Message = document.querySelector('[member2-message]')
    const member3Message = document.querySelector('[member3-message]')
    const member4Message = document.querySelector('[member4-message]')
    const member5Message = document.querySelector('[member5-message]')
    const member6Message = document.querySelector('[member6-message]')
    const member7Message = document.querySelector('[member7-message]')
    const member8Message = document.querySelector('[member8-message]')
    const member9Message = document.querySelector('[member9-message]')
    ...
    const member9Chart = document.querySelector('[member9-chart]')
    const member9Texts = document.querySelector('[member9-texts]')
    const member9Stickers = document.querySelector('[member9-stickers]')
    const member9Photos = document.querySelector('[member9-photos]')
    ...
    member9Name.textContent = members[8]
    ...
    member9Message.textContent = eachMemberMessages[8] + ' 則'
    ...
    member9Chart.textContent = members[8]
    member9Texts.textContent = eachMemberMessages[8] - eachMemberStickers[8] - eachMemberPhotos[8] + ' 訊息'
    member9Stickers.textContent = eachMemberStickers[8] + ' 貼圖'
    member9Photos.textContent = eachMemberPhotos[8] + ' 照片'
